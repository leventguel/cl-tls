(defpackage :tls-aes192-gcm
  (:use :cl :tls-aes-utils :tls-aes-ghash :tls-aes192)
...
(defun aes192-gcm-encrypt (plaintext key iv &optional (aad #()) (taglen 128) (aad-len 0) (ctlen 0))
...
(defun aes192-gcm-decrypt (ciphertext key iv tag &optional (aad #()) (taglen 128) (aad-len 0) (ctlen 0))
